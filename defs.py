...
SQUAD_REWRITES_TRIPLES_TRAIN_AMAZON_TURK_1_JSON = f"{SQUAD_DIR}/train_turk_triples_batch_1.json"
SQUAD_REWRITES_TRIPLES_TRAIN_AMAZON_TURK_2_JSON = f"{SQUAD_DIR}/train_turk_triples_batch_2.json"
SQUAD_REWRITES_TRIPLES_TEST_AMAZON_TURK_JSON = f"{SQUAD_DIR}/test_turk_triples_batch.json"
SQUAD_REWRITES_MAPPED_TRIPLES_TRAIN_AMAZON_TURK_JSON = f"{SQUAD_DIR}/train.mappedtriples.json"
SQUAD_REWRITES_MAPPED_TRIPLES_TRAIN_SYNTH_JSON = f"{SQUAD_DIR}/synthetic.train.mappedtriples.json"
SQUAD_REWRITES_MAPPED_TRIPLES_TEST_AMAZON_TURK_JSON = f"{SQUAD_DIR}/test.mappedtriples.json"
