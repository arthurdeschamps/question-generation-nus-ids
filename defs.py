...
ASS2S_SQUAD_PREDS_OUTPUT_PATH = f"{ASS2S_PRED_DIR}/squad_preds.txt"
...
ASS2S_PROCESSED_SQUAD_DIR = f"{ASS2S_PROCESSED_DIR}/squad"
ASS2S_PROCESSED_MPQG_DATA = f"{ASS2S_PROCESSED_SQUAD_DIR}/mpqg_data"
