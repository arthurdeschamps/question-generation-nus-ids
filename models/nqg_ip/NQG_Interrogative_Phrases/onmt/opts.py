...
def model_opts(parser):
    ...
    #encoderの最後の隠れ状態とデコーダーの最初の隠れ層の間に追加のlayerを与えるか
    ...
    #global_attentionの種類、dot,general,mlp(concat)
...
def preprocess_opts(parser):
    ...
    #データの分割,デフォルトでは、データを分割しない程度に大きなサイズ
    ...
    #すでにsrc,tgt_vocabを生成しているのならばそれを指定
